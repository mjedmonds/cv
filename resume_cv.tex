...
\geometry{left=2cm, top=1.2cm, right=2cm, bottom=1.5cm, footskip=.2cm} % Configure page margins with geometry
...
\position{Artifical Intelligence Researcher{\enskip\cdotp\enskip}Robotics Researcher} % Your expertise/fields
